...
export function DataTableRowActions<TData>({ row }: DataTableRowActionsProps<TData>) {
  ...
  console.log(user.walletAddress); // Note: use the id for any action (example: delete, view, edit)
      ...
      <DropdownMenuContent className="bg-gray-900" align="end">
        <DropdownMenuItem>
          <Button variant={"ghost"} size={"sm"} className={"justify-start w-full"} asChild>
            <Link href={`https://solscan.io/address/${user.walletAddress}`} target="_blank">
