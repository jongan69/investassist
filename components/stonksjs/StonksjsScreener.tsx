...
import { Loader2, TrendingUp, TrendingDown, Activity, Volume2, AlertTriangle, DollarSign } from 'lucide-react'
...
export default function StonksjsScreener() {
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Industry-standard stock screeners powered by Finviz data
        </CardDescription>
      </CardHeader>
