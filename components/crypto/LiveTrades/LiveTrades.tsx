    ...
    <div className="rounded border bg-card p-4 shadow-md flex flex-col w-full mt-10">
      ...
      <ScrollArea.Root className="h-[400px] overflow-hidden rounded">
        ...
        <ScrollArea.Scrollbar
          className="flex touch-none select-none bg-blackA3 p-0.5 transition-colors duration-&lsqb;160ms&rsqb; ease-out hover:bg-blackA5 data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col"
