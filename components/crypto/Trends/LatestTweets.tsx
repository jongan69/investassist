            ...
            {tweetsError ? (
                ...
                <ScrollArea.Root className="h-[500px] overflow-hidden rounded-lg border border-border">
                    ...
                    <ScrollArea.Scrollbar
                        className="flex touch-none select-none bg-secondary/20 p-0.5 transition-colors duration-&lsqb;160ms&rsqb; ease-out hover:bg-secondary/30 data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col rounded-full"
